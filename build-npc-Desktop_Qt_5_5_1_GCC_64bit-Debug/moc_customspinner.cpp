...
#include "../smbx-npc-editor/customspinner.h"
...
struct qt_meta_stringdata_customSpinner_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_customSpinner_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_customSpinner_t qt_meta_stringdata_customSpinner = {
    {
QT_MOC_LITERAL(0, 0, 13), // "customSpinner"
QT_MOC_LITERAL(1, 14, 19), // "on_checkBox_clicked"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "customSpinner\0on_checkBox_clicked\0"
};
...
const QMetaObject customSpinner::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_customSpinner.data,
      qt_meta_data_customSpinner,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *customSpinner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_customSpinner.stringdata0))
